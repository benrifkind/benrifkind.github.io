...
date: 2014-10-30
tags: [R, machine learning, random forest, classification]
---

For my first post I thought I'd write about some basic data classification. I've been going through the courses given by Carnegie Melon in the [Data Science Specialization Stream](https://www.coursera.org/specialization/jhudatascience/1) to learn R and some introductory data science techniques. I recommend it.
...
I am using PCA to reduce dimensionality. First have to center and rescale the data. The centering and scaling comes from the training data.
...
A plot of the first two principal components of the training set. Do they separate the data well? I don't really see good separation...

```r
qplot(PC1, PC2, data = train, colour = train.class)
```

![PCA plot of first two principal components](/figs/2014-10-30-Fit-Analysis/unnamed-chunk-7-1.png)
